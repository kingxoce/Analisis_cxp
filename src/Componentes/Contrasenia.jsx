...
const Contrasenia = () => {
  ...
  const [tableData, setTableData] = useState([
    { id: 1, nombre: 'Cementos Progreso', fechaPromesa: '10-09-2023', documento: '45789653' },
    { id: 2, nombre: 'Stack', fechaPromesa: '22-09-2023', documento: '785421365' },
    { id: 3, nombre: 'Aceros de Guatemala', fechaPromesa: '09-09-2023', documento: '245632864' },
  ]);
  ...
  const handleOpenModal = (id) => {
    ...
    if (id === 0) {
      ...
      setSelectedDocumento('Ingrese número de documento');
  ...
  const filteredData = tableData.filter((item) => {
    return (
      ...
      item.fechaPromesa.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', marginTop: '2%', marginBottom: '10%', marginLeft: '2%' }}>
        <h1 style={{ marginRight: '10px' }}><b>Contraseñas</b></h1>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <div style={{ position: 'relative' }}>
                  <DatePicker
                    ...
                    className={`form-control ${formErrors.fechaPromesa ? 'is-invalid' : ''}`}
                  />
                  <BsCalendar
                    style={{
                      position: 'absolute',
