...
import { BsPlus, BsPencil, BsTrash, BsSearch, BsCalendar,BsPrinter,BsSave,BsFillFileRuledFill,BsFillCalendarEventFill } from 'react-icons/bs';
...
const Abonos = () => {
  ...
  const [tableData, setTableData] = useState([
    { id: 1, proveedor: 'Proveedor A', Nit: '123456789', tipop: 'Transferencia', total: 'Q 1,000.00', Factura: '123131312', Usuario: 'User1',fecha: 'dd/mm/aaaa'  },
    { id: 2, proveedor: 'Proveedor B', Nit: '987654321', tipop: 'Transferencia', total: 'Q 2,000.00', Factura: '123131223', Usuario: 'User1',fecha: 'dd/mm/aaaa'  },
    { id: 3, proveedor: 'Proveedor C', Nit: '098765432', tipop: 'Transferencia', total: 'Q 4,000.00', Factura: '634345345', Usuario: 'User1',fecha: 'dd/mm/aaaa' },
  ]);
  ...
  const handleSave = () => {
    ...
    if (!selectedName) {
      errors.nombre = 'Por favor, ingresa un monto';
    }
        ...
        <Modal show={showModal} onHide={handleCloseModal}>
          ...
          <Modal.Body style={{ maxHeight: 'calc(100vh - 200px)', overflowY: 'scroll' }}>
            <Form>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label><b>Tipo de pago</b></Form.Label>
        
              
                <Form.Select aria-label="Default select example" style={{ width: "37%" }}>
                  <option value="true">Transferencia</option>
                  <option value="false">Cheque</option>
                  <option value="true">Otro</option>
                </Form.Select>
              </Form.Group>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label><b>Fecha de Abono</b></Form.Label>
