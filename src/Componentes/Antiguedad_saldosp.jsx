  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginTop: '1%', marginLeft: '2%' }}>
        <h5><b>Reporte por Proveedor #########      detallada al dd/mm/aaaa</b></h5>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', marginTop: '1%', marginLeft: '2%' }}>
        <h6 style={{ marginRight: '80px' }}><b>Telefono ########</b></h6>
        <h6 style={{ marginRight: '80px' }}><b>Direccion ***********</b></h6>
        <h6 style={{ marginRight: '10px' }}><b>limite de credito #####</b></h6>
      </div>
      <div style={{ margin: '5%' }}>
